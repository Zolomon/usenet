...
memserver: libclientserver.a UseNetServer.o MessageHandler.o DatabaseRAM.o Article.o NewsGroup.o 
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(LDLIBS) UseNetServer.cc MessageHandler.cc DatabaseRAM.cc Article.cc NewsGroup.cc 
